// Mock API Service for AI StoryLand App
// This file provides mock implementations of the backend API calls
// In a real app, these would connect to our actual backend services
...
export const mockStartStory = async (input) => {
  // Simulate API delay
...
export const mockAdaptStory = async (currentStory, input) => {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 1000));
...
// Update app settings
export const mockUpdateSettings = async (newSettings) => {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500));
...
// Enable bedtime mode
export const mockEnableBedtimeMode = async (durationMinutes) => {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500));
...
export const mockDisableBedtimeMode = async () => {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500));
